...
summary(model)
```
We can see that the R-squared is even smaller for such regression. Therefore, this prompts us to look for other factors explaining the mortality rate, who was explained only partially by age.
