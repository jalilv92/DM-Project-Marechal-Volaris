...
This analysis highlights the profound impact of connectivity on mortality during the pandemic. Low-connectivity areas (below 62%) experienced a mean death rate of 31.96%, significantly higher than the 28.51% observed in high-connectivity areas (above 83.2%). Each percentage point increase in connectivity reduces death rates by 0.0328%, explaining 45% of mortality variation. Strong connectivity also supports remote working, reducing exposure risks and enhancing resilience. Investing in connectivity infrastructure is essential to mitigate health disparities.
